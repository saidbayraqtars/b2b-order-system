...
Son güncelleme: 2026-08-01 · Adım 5 sonu (commit `3e2ecda`)
...
- **Ürün/fiyat yönetimi arayüzü yok** — ürün, varyant, fiyat, kategori, iskonto yalnızca seed ile giriliyor.
...
- **Otomatik test yok** — doğrulama manuel HTTP + typecheck + Metro bundle ile yapılıyor.
- Mobil uygulama gerçek cihazda çalıştırılmadı, yalnızca bundle edildi.
- Şifre sıfırlama, e-posta/bildirim, dosya/görsel yükleme yok.

## Sonraki Adımlar (planlanan)

Sıralama kesin değil — öncelik iş ihtiyacına göre belirlenecek.

- **Adım 6 — Katalog yönetimi:** ürün/varyant/fiyat/kategori/iskonto CRUD ekranları. Sistemi seed bağımlılığından kurtarır.
